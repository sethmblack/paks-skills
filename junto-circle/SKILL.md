...
### Purpose Statement
The Founder's Junto exists to accelerate startup success through structured peer learning, mutual aid, and candid problem-solving among early-stage founders building companies in [City].

### Success Metrics
- Member companies receive warm introductions to investors, customers, or hires from fellow members (track quarterly)
- Members report applying insights from discussions to avoid mistakes or seize opportunities
- 80%+ attendance maintained over 6 months
- Net Promoter Score of 9+ when surveyed
...
1. **The Win:** "What's the biggest win or progress since our last meeting?"
...
**Frequency:** Monthly (second Thursday, 6-9 PM)
**Duration:** 3 hours
**Format:** In-person dinner at rotating member's choice of restaurant

| Segment | Duration | Purpose |
|---------|----------|---------|
| Dinner and informal catch-up | 30 min | Build relationships beyond business |
| Standing questions (2 min each) | 40 min | Surface what's happening across all companies |
...
After 12 months, encourage founding members to:
- Start a second Junto for founders at different stage or industry
- Use the same template and standing questions
